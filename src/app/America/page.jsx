...
export default async function Home() {
  ...
  const South = data.filter(country => country.continents.includes  ('America'))
  ...
  return (
    <div>
     <h1 className='flex flex-col items-center h-[50px] justify-center m-4 bg-slate-500 text-white'>South America Countries</h1>
    ...
    <p>{`We have ${countries.length} countries in South America`}</p>
    </footer>
    </div>
  )
  }
